...
import reactLogo from './assets/arrow.svg'
        ...
        <div className="package__wrapper">
          <div className="package">
            <div className="package__content">
              <img
                className="package__icon package__icon--css"
                src="easel.png"
              />
              <img
                className="package__icon package__icon--html"
                src="Brush.png"
              />
              <img
                className="package__icon package__icon--js"
                src="colorboard.png"
              />
            </div>
          ...
          <div style={{ paddingLeft: "60%", fontSize: "60px" }}>66%</div>
